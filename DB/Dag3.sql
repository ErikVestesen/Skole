...
insert into customer values(2,'Callan', 120, 'Allan', '1992-01-17');
insert into customer values(3,'Dallan', 130, 'Callan', '1993-01-09');
...
--	(
--	select Datepart(mm,GETDATE()) as idag
--	)